...
# giving up: delays increase each attempt (t=5, 60, 360, 1260) so we don't
# keep hammering Twitch while a clip is still processing, well past their
...
# giving up on a slow one. Pushed further out than the original 5/10/15/20
# schedule to test whether some of the remaining metadata_fetch failures are
# clips that just need more than 50s to become queryable.
GET_CLIP_MAX_ATTEMPTS = 4
GET_CLIP_RETRY_DELAYS = [5, 55, 300, 900]  # seconds before each attempt (t=5,60,360,1260)
