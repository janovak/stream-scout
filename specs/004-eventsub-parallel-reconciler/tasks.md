...
- [x] T046 [US3] DONE 2026-08-29 — 27,413 live records: `sent_at` an epoch-ms int in every one, 0 null, 0 non-int. Skew against ingestion `timestamp` min 99 / p50 168 / p95 235 / p99 270 / max 1,219 ms, **0 outside the 2 s tolerance**
...
the operating point (23 broadcasters) rather than 500**, because a 500-channel
